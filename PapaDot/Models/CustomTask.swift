...
struct CustomTask: Identifiable, Codable, Equatable, Hashable {
    ...
    static var defaultTasks: [CustomTask] {
        [
            ...
            CustomTask(name: "4-Putt",    points: 3, isExclusive: false, isNegative: true,  hasCarryOver: false),
            CustomTask(name: "Lady's Tee", points: 3, isExclusive: false, isNegative: true,  hasCarryOver: false)
        ]
    }
}
